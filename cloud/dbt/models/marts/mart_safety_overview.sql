...
-- Daily bike availability snapshot
daily_bikes as (
    select
        snapshot_date,
        count(distinct station_id)                  as total_stations,
        sum(nb_bikes)                               as total_bikes_available,
        sum(nb_docks)                               as total_capacity,
...
left join daily_bikes b
    on b.snapshot_date = c.month_date
order by c.month_date desc, c.incident_count desc
